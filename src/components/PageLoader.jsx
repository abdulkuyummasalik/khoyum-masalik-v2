...
const loaders = [
  ...
  () => (
    <div
      className="w-8 h-8 rounded-full border-2 border-foreground/20 border-t-emerald-400"
...
const AVATAR_URL = "https://www.abdulkuyummasalik.my.id/khoyum.jpg";
...
export default function PageLoader({ variant = "initial" }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[2000] flex items-center justify-center bg-background text-foreground"
      style={{
    ...
    >
      ...
      {isInitial ? (
        <div className="relative z-10 w-full max-w-sm sm:max-w-md px-6">
          <div className="relative rounded-[28px] border border-foreground/10 bg-foreground/[0.04] backdrop-blur-2xl px-6 py-6 sm:px-8 sm:py-8 shadow-[0_24px_80px_rgba(0,0,0,0.7)]">
            <div
            ...
            <div className="relative flex items-center gap-4 sm:gap-5 mb-6">
              <div className="relative">
                ...
                />
                <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl overflow-hidden border border-foreground/25 bg-card/80">
                  <img
                    src={AVATAR_URL}
                    alt="Khoyum Masalik"
              ...
              <div className="flex flex-col gap-0.5">
                <p className="text-[10px] sm:text-xs tracking-[0.25em] uppercase text-foreground/50">
                  Loading Portfolio
                </p>
            ...
            <div className="relative mb-5">
              <div className="mb-2 flex items-center justify-between text-[10px] sm:text-xs text-foreground/55">
            ...
            <div className="relative flex items-center justify-between text-[10px] sm:text-xs text-foreground/45">
            ...
            <div className="relative mt-6 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 text-[11px] sm:text-xs text-foreground/60">
                <Loader />
              </div>
            </div>
        ...
        <div className="relative z-10 w-full px-6 flex justify-center">
          <div className="w-full max-w-xs sm:max-w-sm">
            <div className="rounded-full border border-foreground/10 bg-foreground/[0.05] backdrop-blur-xl px-4 py-2.5 sm:py-3 flex items-center justify-between gap-3 shadow-[0_12px_40px_rgba(0,0,0,0.6)]">
              ...
              <div className="relative w-16 sm:w-20 h-1.5 rounded-full bg-foreground/10 overflow-hidden">
                <div
                  className="absolute inset-y-0 left-0 w-1/2 rounded-full"
                  style={{
                    background:

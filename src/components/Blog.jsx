  ...
  return (
    ...
    >
      ...
      <div className="km-container relative z-10">
        <div className="relative rounded-[24px] sm:rounded-[28px] border border-foreground/10 p-4 sm:p-6 lg:p-8 overflow-hidden bg-gradient-to-b from-white/5 to-white/[0.04]">
          {/* Grid overlay */}
          <div
                    ...
                    >
                      ...
                      <div className="px-4 pb-5">
                        <div className="flex items-center justify-between text-xs text-foreground/50 mb-2">
                          <span className="px-2 py-0.5 rounded-full bg-foreground/5 border border-foreground/10 text-foreground/70">
                            {p.tags?.[0] || "Article"}
                          </span>
                        ...
                        <p className="text-xs sm:text-sm text-foreground/50 line-clamp-2">
                          {p.excerpt}
                        </p>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-3 relative z-10">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handlePrev}
                className="inline-flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-b from-white/10 to-white/5 border border-foreground/10 hover:bg-foreground/15 transition-colors"
            ...
            >
              <Link
                to="/blog"
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 rounded-full bg-foreground/10 hover:bg-foreground/20 transition-colors text-sm font-medium whitespace-nowrap"
              >
                Lihat semua tulisan
                <ArrowRight className="w-4 h-4" />
              </Link>

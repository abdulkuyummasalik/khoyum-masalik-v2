...
const Gallery = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div className="km-container mb-12 text-center relative z-10">
        <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-white/80 mb-6">
          Our Projects
        </div>
        <SectionHeader
